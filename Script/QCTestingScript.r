...
df<-read_tsv("Data/test_MER_Structured_Datasets_PSNU_IM_FY18-21_20201113_Mozambique.txt") %>% 
  mutate(pre_rgnlztn_hq_mech_code = as.character(pre_rgnlztn_hq_mech_code))
df1<-read_tsv("Data/test_MER_Structured_Datasets_PSNU_IM_FY18-21_20201113_Eswatini.txt")
glimpse(df)
glimpse(df1)
...
write_tsv(fdf, "Data/EsMozPanoQC20201116.txt", na = " ")
